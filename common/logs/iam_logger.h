...
#define PIN_LOG_DEBUG(...) HILOG_DEBUG(LOG_CORE, __VA_ARGS__)
#define PIN_LOG_INFO(...) HILOG_INFO(LOG_CORE, __VA_ARGS__)
#define PIN_LOG_WARN(...) HILOG_WARN(LOG_CORE, __VA_ARGS__)
#define PIN_LOG_ERROR(...) HILOG_ERROR(LOG_CORE, __VA_ARGS__)
#define PIN_LOG_FATAL(...) HILOG_FATAL(LOG_CORE, __VA_ARGS__)

#define ARGS(fmt, ...) "[%{public}s@%{public}s:%{public}d] " fmt, __FUNCTION__, PIN_AUTH_FILE, __LINE__, ##__VA_ARGS__
#define PIN_LOG(level, ...) PIN_LOG_##level(ARGS(__VA_ARGS__))
