...
using IExecutorCallback = OHOS::HDI::PinAuth::V3_0::IExecutorCallback;

using AuthType = OHOS::HDI::PinAuth::V3_0::AuthType;
using ExecutorRole = OHOS::HDI::PinAuth::V3_0::ExecutorRole;
using ExecutorSecureLevel = OHOS::HDI::PinAuth::V3_0::ExecutorSecureLevel;
using ExecutorInfo = OHOS::HDI::PinAuth::V3_0::ExecutorInfo;
