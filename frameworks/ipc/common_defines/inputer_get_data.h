...
enum GetDataMode : int32_t {
    ...
    GET_DATA_MODE_ALL_IN_ONE_PIN_ENROLL = 1,
    GET_DATA_MODE_ALL_IN_ONE_PIN_AUTH = 2,
    GET_DATA_MODE_COLLECTOR_PIN_AUTH = 3,
    GET_DATA_MODE_ALL_IN_ONE_RECOVERY_KEY_ENROLL = 4,
    GET_DATA_MODE_ALL_IN_ONE_RECOVERY_KEY_AUTH = 5,
    GET_DATA_MODE_ALL_IN_ONE_PRIVATE_PIN_ENROLL = 6,
    GET_DATA_MODE_ALL_IN_ONE_PRIVATE_PIN_AUTH = 7,
};
