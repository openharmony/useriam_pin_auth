...
#ifndef MOCK_IVERIFIER_EXECUTOR_FUZZER_H
#define MOCK_IVERIFIER_EXECUTOR_FUZZER_H
...
int32_t MockIVerifierExecutorFuzzer::isTrueTest()
{
    isTrue_ = !isTrue_;
...
#endif // MOCK_IVERIFIER_EXECUTOR_FUZZER_H