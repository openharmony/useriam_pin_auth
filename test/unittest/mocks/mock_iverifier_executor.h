...
#ifndef MOCK_IVERIFY_EXECUTOR_H
#define MOCK_IVERIFY_EXECUTOR_H
...
class MockIVerifyExecutor : public IVerifier {
public:
    virtual ~MockIVerifyExecutor() = default;
    ...
    MOCK_METHOD1(NotifyCollectorReady, int32_t(uint64_t scheduleId));
};
} // namespace PinAuth
} // namespace UserIam
} // namespace OHOS

#endif // MOCK_IVERIFY_EXECUTOR_H